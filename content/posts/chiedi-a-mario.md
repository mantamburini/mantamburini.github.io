...
Quattro domande diverse. Stessa risposta: "Chiedi a Mario."
...
Non è un problema astratto di "gestione della conoscenza". Ha un costo concreto.
...
- **Cosa si fa**: i passi, in ordine, con le eccezioni rilevanti
...
Per chi gestisce un reparto IT di una media azienda e ha già capito che Mario è un rischio, ma non ha ancora trovato un modo pratico per ridurlo.
